...
- [ ] It should allow users to select and send one file at a time
...
- [ ] It should limit users to sending 2.5 GB per Send.
...
- [ ] It should trigger a notification when a share link expires
